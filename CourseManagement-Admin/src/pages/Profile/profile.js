                        ...
                        <Row justify="center">
                            <Col span="9" style={{ marginTop: 20, marginLeft: 20, marginRight: 20 }}>
                                <Card hoverable={true} className="profile-card" style={{ padding: 0, margin: 0 }}>
                                    <Row justify="center">
                                        <img
                                            src="https://i.ibb.co/HYWSpYm/97d0c0bd-fb71-4ebf-b325-07b5603914eb.jpg"
                                            style={{
                                                width: 150,
                                                height: 150,
                                                borderRadius: '50%', 
                                    ...
                                    <Row justify="center">
                                        <Col span="24">
                                            <Row justify="center">
                                                <strong style={{ fontSize: 18 }}>{userData?.hoTen}</strong>
                                            </Row>
                                            <Row justify="center">
                                                <p style={{ padding: 0, margin: 0, marginBottom: 5 }}>{userData?.email}</p>
                                            </Row>
                                            <Row justify="center">
                                                <p style={{ padding: 0, margin: 0, marginBottom: 0 }}>Mã nhóm: {userData?.maNhom}</p>
                                            </Row>
                                            <Row justify="center">
                                                <p style={{ padding: 0, margin: 0, marginBottom: 5 }}>Số điện thoại: {userData?.soDT}</p>
                                            </Row>
